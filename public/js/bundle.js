...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SearchResults = __webpack_require__(213);
	...
	exports.default = _react2.default.createElement(
	    ...
	    _react2.default.createElement(_reactRouter.Route, { path: 'results/:searchterm', component: _SearchResults2.default }),
	    _react2.default.createElement(_reactRouter.Route, { path: 'artist/:mbid', component: _Artist2.default }),
	    _react2.default.createElement(_reactRouter.Route, { path: 'artist/:mbid/album/:albummbid', component: _AlbumInfo2.default }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SearchLastFM = __webpack_require__(212);

	var _SearchLastFM2 = _interopRequireDefault(_SearchLastFM);

	var _SearchResults = __webpack_require__(213);

	var _SearchResults2 = _interopRequireDefault(_SearchResults);

	var _music = __webpack_require__(214);
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(_SearchLastFM2.default, { history: history, searchArtist: function searchArtist(searchname) {
	                                return _this2.doSearch(searchname);
	                            } })
	                    )
	                ),
	                _react2.default.createElement(_ScreenInfo2.default, null),
	                _react2.default.createElement(
	                    'div',
	                    { className: '' },
	                    this.props.children
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchLastFM = (function (_React$Component) {
	    _inherits(SearchLastFM, _React$Component);

	    function SearchLastFM(props) {
	        _classCallCheck(this, SearchLastFM);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(SearchLastFM).call(this, props));

	        _this.displayName = 'SearchLastFM';
	        return _this;
	    }

	    _createClass(SearchLastFM, [{
	        key: 'getRef',
	        ...
	        value: function handleSubmit() {
	            var searchname = this.searchname.value;
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'form',
	                { className: 'navbar-form navbar-right', onSubmit: function onSubmit() {
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'li',
	                        null,
	                        _react2.default.createElement('input', { type: 'search', placeholder: 'Search Artists', className: 'form-control', ref: function ref(_ref) {
	...
	SearchLastFM.propTypes = {
	    ...
	    searchArtist: _react2.default.PropTypes.func.isRequired
	};

	exports.default = SearchLastFM;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchResults = (function (_React$Component) {
	    ...
	    function SearchResults(props) {
	        ...
	        _this.displayName = 'SearchResults';
	        _this.state = {
	            artists: []
	        };
	        return _this;
	    ...
	    _createClass(SearchResults, [{
	        ...
	        key: 'init',
	        value: function init(searchterm) {
	            _music2.default.searchLastFMArtist(searchterm).then((function (results) {
	                // console.log('searchLastFMArtist > artist ::: ', results.data.results.artistmatches.artist);
	                // I want only those with an mbid...
	                var filtered = results.data.results.artistmatches.artist.filter(function (o) {
	                    return o.mbid;
	                });
	                this.setState({
	                    artists: filtered
	        ...
	        value: function render() {
	            ...
	            if (!this.state.artists.length) {
	                return _react2.default.createElement(
	                    'div',
	                    null,
	                    _react2.default.createElement(_Breadcrumbs2.default, { links: [] }),
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'row' },
	                        _react2.default.createElement(
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'row small-up-2 medium-up-3 large-up-5 row-artist' },
	                        ...
	                        return _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    ...
	                                    _react2.default.createElement(
	                                        'div',
	                                        { onClick: _this2.handleSubmit.bind(_this2, artist), className: 'thumbnail text-center faked-active' },
	                                        _react2.default.createElement('image', { src: artist.image && artist.image[2]['#text'] ? artist.image[2]['#text'] : 'http://placehold.it/174x174' }),
	                                        _react2.default.createElement(
	                                            'p',
	                                            null,
	                                            artist.name
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _axios = __webpack_require__(215);
	...
	function searchArtists(artist) {
	    return _axios2.default.get('http://ws.audioscrobbler.com/2.0/?method=artist.search&artist=' + artist + '&format=json&limit=5&api_key=' + _keys2.default.lastfm);
	}
	// From similar artist - so the name is set by last.fm - so no need to search
	function getArtistByName(artist) {
	    return _axios2.default.get('http://ws.audioscrobbler.com/2.0/?method=artist.getInfo&artist=' + artist + '&format=json&limit=1&api_key=' + _keys2.default.lastfm);
	}
	function _getArtistInfo(mbid) {
	    return _axios2.default.get('http://ws.audioscrobbler.com/2.0/?method=artist.getInfo&mbid=' + mbid + '&format=json&api_key=' + _keys2.default.lastfm);
	}
	function _getTopAlbums(mbid) {
	    return _axios2.default.get('http://ws.audioscrobbler.com/2.0/?method=artist.getTopAlbums&mbid=' + mbid + '&format=json&limit=10&api_key=' + _keys2.default.lastfm);
	}
	function _getAlbumInfo(mbid) {
	    return _axios2.default.get('http://ws.audioscrobbler.com/2.0/?method=album.getInfo&mbid=' + mbid + '&format=json&api_key=' + _keys2.default.lastfm);
	}
	var LastFM = {
	    searchLastFMArtist: function searchLastFMArtist(artist) {
	        // console.log('searchLastFMArtist ::: ', artist);
	        return searchArtists(artist);
	    },
	    getSimilarArtist: function getSimilarArtist(artist) {
	        // console.log('getArtist ::: ', artist);
	        return getArtistByName(artist);
	    },
	    getArtistInfo: function getArtistInfo(mbid) {
	        // console.log('getArtistInfo ::: ', mbid);
	        return _getArtistInfo(mbid);
	    },
	    getTopAlbums: function getTopAlbums(mbid) {
	        // console.log('getTopAlbums ::: ', mbid);
	        return _getTopAlbums(mbid);
	    },
	    getAllArtist: function getAllArtist(mbid) {
	        // console.log('getAllArtist ::: ', mbid);
	        return _axios2.default.all([_getArtistInfo(mbid), _getTopAlbums(mbid)]).then(function (arr) {
	            return { artist: arr[0].data.artist, albums: arr[1].data.topalbums.album };
	        });
	    },
	    getAllArtistByName: function getAllArtistByName(artist) {
	        // console.log('getAllArtistByName ::: ', artist);
	        return getArtistByName(artist).then(function (result) {
	            var artist = result.data.artist;
	            return _axios2.default.all([_getArtistInfo(artist.mbid), _getTopAlbums(artist.mbid)]);
	        }).then(function (arr) {
	            return { artist: arr[0].data.artist, albums: arr[1].data.topalbums.album };
	        });
	    },
	    getAlbumInfo: function getAlbumInfo(mbid) {
	        // console.log('getAlbumInfo ::: ', mbid);
	        return _getAlbumInfo(mbid);
	    }
	};
	  ...
	  return new Promise(function executor(resolve, reject) {
	    try {
	      if ((typeof XMLHttpRequest !== 'undefined') || (typeof ActiveXObject !== 'undefined')) {
	        ...
	        __webpack_require__(220)(resolve, reject, config);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var btoa = window.btoa || __webpack_require__(225);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ScreenInfo = function ScreenInfo(_ref) {
	    ...
	    var albumInfo = _ref.albumInfo;

	    return _react2.default.createElement(
	        "div",
	        { className: "row dev-info" },
	        _react2.default.createElement(
	            "div",
	            { className: "small-12 columns" },
	            _react2.default.createElement(
	                "p",
	                { className: "show-for-small-only float-left" },
	                _react2.default.createElement(
	                    "span",
	                    { className: "label" },
	                    "Small screen"
	            ...
	            _react2.default.createElement(
	                "p",
	                { className: "show-for-medium-only float-left" },
	                _react2.default.createElement(
	                    "span",
	                    { className: "label" },
	                    "Medium screen"
	            ...
	            _react2.default.createElement(
	                "p",
	                { className: "show-for-large float-left" },
	                _react2.default.createElement(
	                    "span",
	                    { className: "label" },
	                    "Large+ screen"
	            ...
	            _react2.default.createElement(
	                "p",
	                { className: "show-for-landscape float-left" },
	                _react2.default.createElement(
	                    "span",
	            ...
	            _react2.default.createElement(
	                "p",
	                { className: "show-for-portrait float-left" },
	                _react2.default.createElement(
	                    "span",
	                    { className: "label success" },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Home = (function (_React$Component) {
	    ...
	    _createClass(Home, [{
	        key: 'init',
	        value: function init(searchname) {
	            if (!searchname) {
	                return;
	            }
	            getLastFMArtist(searchname).then((function (data) {
	                this.setState({
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement('img', { className: 'thumbnail', src: 'img/logos/lastfm_black.png', alt: 'Last.fm' })
	                        ),
	                        _react2.default.createElement(
	                            'h5',
	                            null,
	                        ...
	                        _react2.default.createElement(
	                            'p',
	                            null,
	                            'Search Last.fm for a group/artist...'
	                        )
	                    )
	                ),
	                _react2.default.createElement('div', { className: 'col-sm-4' })
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Artist = (function (_React$Component) {
	    ...
	    function Artist(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Artist).call(this, props));

	        _this.displayName = 'Artist';
	        _this.state = {
	            artist: {},
	            albums: []
	        };
	    ...
	    _createClass(Artist, [{
	        ...
	        key: 'init',
	        value: function init(mbid) {
	            _music2.default.getAllArtist(mbid).then((function (result) {
	        ...
	        key: 'getSimilar',
	        value: function getSimilar(artist) {
	            _music2.default.getSimilarArtist(artist).then((function (result) {
	                if (result.data.artist.mbid) {
	                    // some results do not have the mbid...or maybe not for similar suggested artists?
	        ...
	        key: 'getAlbumInfo',
	        value: function getAlbumInfo(albummbid) {
	            this.props.history.pushState(null, '/artist/' + this.state.artist.mbid + '/album/' + albummbid);
	        }
	    }, {
	        key: 'getBreadcrumbs',
	        value: function getBreadcrumbs(mbid, artist, album) {
	            return [{ href: null, text: artist }];
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            var _state$artist = this.state.artist;
	            var bio = _state$artist.bio;
	            var image = _state$artist.image;
	            var ontour = _state$artist.ontour;
	            var stats = _state$artist.stats;
	            var artistName = _state$artist.name;
	            var url = _state$artist.url;

	            var links = this.getBreadcrumbs(this.props.params.mbid, artistName);

	            // Quick hack to add blank target - not clever
	            var summary = bio && bio.summary || '';
	            summary = summary.replace('<a href', '<a target="_blank" href');

	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(_Breadcrumbs2.default, { links: links }),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'row' },
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    'div',
	                                    { className: 'thumbnail' },
	                                    _react2.default.createElement('image', { src: image && image[3]['#text'] })
	                                )
	                            ),
	                            _react2.default.createElement(
	                                'div',
	                                ...
	                                _react2.default.createElement(
	                                    ...
	                                    artistName,
	                                    ' ',
	                                    ontour === "1" && _react2.default.createElement(
	                                        'span',
	                                        { className: 'label float-right' },
	                                        'On Tour'
	                                    )
	                                ),
	                                _react2.default.createElement('p', { dangerouslySetInnerHTML: { __html: summary && summary } }),
	                                _react2.default.createElement(
	                                    'p',
	                                    null,
	                                    _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(_Similar2.default, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Albums = function Albums(_ref) {
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_AlbumList2.default, { albums: albums, albumInfo: albumInfo })
	    );
	};

	Albums.propTypes = {
	    albums: _react2.default.PropTypes.array.isRequired,
	    albumInfo: _react2.default.PropTypes.func.isRequired
	};
	    ...
	    */
	    ...
	    return _react2.default.createElement(
	        ...
	        albums.map(function (album, index) {
	            return _react2.default.createElement(
	                "li",
	                { className: "no-bullet album-list", key: index },
	                _react2.default.createElement(
	                    "div",
	                    { className: "media-object stack-for-small" },
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                "a",
	                                { className: "thumbnail text-center", href: album.url, target: "_blank" },
	                                _react2.default.createElement("image", { src: album.image && album.image[2]['#text'] ? album.image[2]['#text'] : 'http://placehold.it/174x174' })
	                            )
	                        )
	                    ),
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                "div",
	                                { className: "small-12 columns" },
	                                album.mbid && _react2.default.createElement(
	                                    "button",
	                                    { className: "button success hollow small", onClick: function onClick() {
	                                            return albumInfo(album.mbid);
	                                        } },
	                                    album.name
	                                )
	                            ),
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    "a",
	                                    { className: "primary small button hollow", href: 'http://www.amazon.co.uk/s/ref=as_li_qf_sp_asin_il_tl?url=search-alias%3Daps&tag=sinisterwaltz-21&field-keywords=' + album.artist.name + '+' + album.name, target: "_blank" },
	                                    "Buy"
	                                )
	                            )
	                        )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Similar = function Similar(_ref) {
	    var artist = _ref.artist;
	    var similarArtist = _ref.similarArtist;
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_SimilarList2.default, { artist: artist, similarArtist: similarArtist })
	    );
	};

	Similar.propTypes = {
	    artist: _react2.default.PropTypes.object.isRequired,
	    similarArtist: _react2.default.PropTypes.func.isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SimilarList = (function (_React$Component) {
	    _inherits(SimilarList, _React$Component);

	    function SimilarList(props) {
	        _classCallCheck(this, SimilarList);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(SimilarList).call(this, props));

	        _this.displayName = 'SimilarList';
	        return _this;
	    }

	    _createClass(SimilarList, [{
	        key: 'render',
	        value: function render() {
	            var _this2 = this;

	            var similarArray = this.props.artist.similar ? this.props.artist.similar.artist : [];
	            return _react2.default.createElement(
	                'ul',
	                { className: 'list-group' },
	                similarArray.map(function (similar, index) {
	                    return _react2.default.createElement(
	                        'li',
	                        { className: 'no-bullet album-list', key: index },
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    ...
	                                    _react2.default.createElement(
	                                        'a',
	                                        { className: 'thumbnail text-center', href: similar.url, target: '_blank' },
	                                        _react2.default.createElement('image', { src: similar.image && similar.image[2]['#text'] })
	                                    )
	                                )
	                            ),
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    'button',
	                                    { className: 'button success hollow small', onClick: function onClick() {
	                                            return _this2.props.similarArtist(similar.name);
	                                        } },
	                                    similar.name
	                                )
	                            )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AlbumInfo = (function (_React$Component) {
	    _inherits(AlbumInfo, _React$Component);

	    function AlbumInfo(props) {
	        _classCallCheck(this, AlbumInfo);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(AlbumInfo).call(this, props));

	        _this.displayName = 'AlbumInfo';
	        _this.state = {
	            album: {},
	            tracks: [],
	            error: false
	    ...
	    _createClass(AlbumInfo, [{
	        ...
	        key: 'getBreadcrumbs',
	        value: function getBreadcrumbs(mbid, artist, album) {
	            return [{ href: '#/artist/' + mbid, text: artist }, { href: null, text: album }];
	        }
	    }, {
	        key: 'init',
	        value: function init(albummbid) {

	            _music2.default.getAlbumInfo(albummbid).then((function (results) {
	                console.log('getAlbumInfo > ::: ', results);
	                var data = results.data,
	                    error = !!data.error,
	                    // could use data.message...
	        ...
	        value: function render() {
	            ...
	            var _state$album = this.state.album;
	            var artist = _state$album.artist;
	            var image = _state$album.image;
	            var mbid = _state$album.mbid;
	            var albumName = _state$album.name;
	            var tracks = _state$album.tracks;
	            var url = _state$album.url;
	            var playcount = _state$album.playcount;
	            var listeners = _state$album.listeners;
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(_Tracks2.default, { tracks: this.state.tracks })
	                            )
	                        )
	                    )
	                )
...
/***/ function(module, exports, __webpack_require__) {
	...
	Tracks.propTypes = {
	    tracks: _react2.default.PropTypes.array.isRequired
	};
